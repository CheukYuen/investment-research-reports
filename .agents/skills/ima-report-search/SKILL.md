---
name: ima-report-search
description: |
  检索本机由腾讯 IMA 同步的券商研报库（约 6200 篇）。
  当用户明确要搜索本地/IMA 研报库、定位已同步或已下载的 PDF，
  或在 investment-research-reports 项目中按主题、公司、行业、优先级查找研报时使用。
  普通全网或同花顺研报搜索不要使用此 skill。
