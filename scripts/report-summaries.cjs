...
function validateAndNormalizeSuccess(record, indexRecord) {
  ...
  return {
    ...
    entities,
    evidence,
    prompt_version: normalizeText(record.prompt_version || 'ima-download-screen-summary-batch-v7'),
...
function normalizeFailure(record, indexRecord) {
  ...
  return {
    ...
    entities: [],
    evidence: [],
    prompt_version: normalizeText(record && record.prompt_version) || 'ima-download-screen-summary-batch-v7',
